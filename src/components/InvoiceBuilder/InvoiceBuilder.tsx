...
const cleanFormData = (invoiceFormData: InvoiceFormData | undefined) => {
	if (!invoiceFormData) {
		return null;
	}
...
const InvoiceBuilder: React.FC<InvoiceProps> = ({ onAction, defaultFormData = undefined }) => {
	const [invoiceFormData, setInvoiceFormData] = React.useState<InvoiceFormData | undefined>(
		undefined
	);
